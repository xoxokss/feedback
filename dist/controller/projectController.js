...
var ProjectController = /** @class */ (function () {
    ...
    ProjectController.getProjectsAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var query, headers, userId, projects, e_1, error;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, project_1.ProjectModel.findAll()];
                    case 2:
                        projects = _a.sent();
    ...
    ProjectController.addProject = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, title, intro, content, surveyId, imageId, tags, user, surveyCopy, projectResult, err_1;
    ...
    ProjectController.modifyProject = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, title, intro, content, surveyId, imageId, tags, user, surveyCopy, projectResult, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = req.params.id;
